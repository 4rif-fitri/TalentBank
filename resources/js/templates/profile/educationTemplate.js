...
export function templateEmptyEducation() {
    return `    <div class="carousel-item active">
...
export function templateBadgeEducationSkill(skill) {
    return `<div class="badge text-bg-secondary m-1">
                ${skill.skill_name}
            </div>`
}

export function templateImageEducation(imageUrl, educationId, index) {
...
export function templateImageEducationMore(imageUrl, educationId, index, remaining) {
...
export function templateCardEducation(education) {
