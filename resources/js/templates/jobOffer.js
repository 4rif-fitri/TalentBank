            ...
            <div>
                ...
                <div>
                   <button id="btnMessageStudent" class="btn btn-outline-primary btn-message-student">
                    ...
                    <button ${data.offer_status != "Pending" ? "disabled" : ""} id="btnWithdrawJobOffer" data-id=${data.id} ${data.invitation_status === "Pending" ? "disabled" : ""} class="btn-withdraw-invitation btn btn-outline-danger ${data.invitation_status === "Pending" ? "disabled" : ""}">
                        <i class="fa-regular fa-trash-can text-danger"></i>
                        Withdraw JobOffer
                    </button>
                    <button ${data.offer_status != "Pending" ? "disabled" : ""} id="btnEditJobOffer" data-id=${data.id} ${data.invitation_status === "Pending" ? "disabled" : ""} class="${data.invitation_status === "Pending" ? "disabled" : ""} btn btn-outline-info text-black btn-edit-invitation">
