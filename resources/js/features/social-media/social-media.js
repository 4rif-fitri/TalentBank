export let student = {
    ...
    badgeSocialMedia: link => {
        return `<a class="badge text-bg-light d-flex align-items-center gap-1"
    ...
    socialMediaRow: (linkId, socialMediaId, name, icon, link) => {
        return `<div class="alert alert-light d-flex align-items-center gap-3 p-2 social-media-row"
            data-id="${linkId}"
