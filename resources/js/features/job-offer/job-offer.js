        ...
        return `<div class="h-100 border-0 p-3 position-relative">
                ...
                <div class="mt-2">
                    ...
                    <div class=" d-flex gap-1">
                        ...
                        <div class="btnContainer">
                            <button ${inv.offer_status == "Pending" ? "" : "disabled"}  data-id=${inv.id} class="btn btn-outline-danger btnRejectInvitation">
                                <i class="fa-regular fa-trash-can text-danger"></i>
                                Decline
                            </button>
                            <button ${inv.offer_status == "Pending" ? "" : "disabled"} data-id=${inv.id} class="btn btn-outline-primary btnAcceptInvitation">
                                <i class="fa-solid fa-pen text-primary"></i>
                                Accept Invitation
                            </button>
                        </div>
