        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="/" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('assets/images/logo/JobTalent-logo-cropped-cropped.svg')}}" alt="" height="25">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('assets/landing-page/img/JobTalent-logo-cropped.svg')}}" alt="" height="60">
                    </span>
                </a>

                <a href="/internship" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('assets/images/logo/JobTalent-logo-cropped-cropped.svg')}}" alt="" height="25">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('assets/images/logo/JobTalent-logo.svg')}}" alt="" height="60">
                    </span>
                </a>
            </div>
