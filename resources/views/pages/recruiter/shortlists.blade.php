...
@section('content')
            ...
            <aside class="filter-panel" id="filterPanel">
                <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-3">
                    ...
                    <button type="button" class="btn btn-outline-primary d-flex justify-content-center align-items-center"
                        data-bs-toggle="modal" data-bs-target="#addShortlistModal">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                                ...
                                <li>
                                    <button class="dropdown-item" data-bs-toggle="modal"
                                        data-bs-target="#addShortlistModal">
                                ...
                                <li>
                                    <button class="dropdown-item text-danger" id="btnDeleteShortlist">
    ...
    <div class="modal fade" id="addShortlistModal" tabindex="-1" aria-labelledby="addShortlistModal"
        aria-hidden="true">
