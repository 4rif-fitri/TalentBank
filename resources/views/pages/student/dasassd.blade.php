...
<section id="education" class="d-flex flex-column gap-1">
    ...
    <div id="educationCarousel" class="carousel slide" data-bs-interval="false" data-bs-touch="true">
        ...
        <div class="carousel-inner" id="educationList" style="height: max-content;">
            <!-- Generated by JS -->
        </div>
        <!-- Dot navigation -->
...
@endpush
        ...
        <div class="carousel-item active">
            <div class="d-flex justify-content-center align-items-center" style="height: 200px;">
                <p class="text-muted">No education found.</p>
            </div>
        </div>
        `)
        return
        ...
        let educationItem = `
        <div data-education-id=${education.id} class="carousel-item">
            <div class="card p-3">
                <h5 class="card-title">${education.programme.organization.company_name}</h5>
                <p class="card-text mb-1">${education.programme.programme_name}</p>
                <p class="card-text mb-1">${education.start_date} - ${education.end_date}</p>
                <p class="card-text mb-1">${education.description}</p>
                <div class="skills d-flex flex-wrap align-items-start"> ${renderSkills(education.skills ?? [])}</div>
            </div>
        </div>`
        educationList.append(educationItem)
        // educationList.find(".images").append(renderImage(education.media, education.id))
        })
